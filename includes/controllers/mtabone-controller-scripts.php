<?php
    ...
    function mtabone_loadScripts() {
        ...
        wp_localize_script('mtabone_general_scripts','wpa_data_general', $script_generalData );
        //------------------------<
        ...
        wp_localize_script('mtabone_content_scripts','wpa_data_content', $script_contentData );
        //------------------------<
        ...
        wp_localize_script('mtabone_settings_scripts','wpa_data_manageSettings', $script_settingsData );
        //------------------------<
    }
